...
__Note:__ Links currently go to the test for the check.

UnextendedSealedTrait, [UseLog1p](test/scala/LinterPluginTest.scala#L667), [UseExpm1](test/scala/LinterPluginTest.scala#L713), UnlikelyEquality, [UseHypot](test/scala/LinterPluginTest.scala#L165), [UseCbrt](test/scala/LinterPluginTest.scala#L187), [UseSqrt](test/scala/LinterPluginTest.scala#L197), [UseExp](test/scala/LinterPluginTest.scala#L207), [UseLog10](test/scala/LinterPluginTest.scala#L218), UseAbsNotSqrtSquare, UseIsNanNotSelfComparison, UseIsNanNotNanComparison, UseSignum, BigDecimalNumberFormat, BigDecimalPrecisionLoss, ReflexiveAssignment, [CloseSourceFile](test/scala/LinterPluginTest.scala#L501), [JavaConverters](test/scala/LinterPluginTest.scala#L512), [ContainsTypeMismatch](test/scala/LinterPluginTest.scala#L518), [NumberInstanceOf](test/scala/LinterPluginTest.scala#L144), [PatternMatchConstant](test/scala/LinterPluginTest.scala#L624), PreferIfToBooleanMatch, [IdenticalCaseBodies](test/scala/LinterPluginTest.scala#L578), IdenticalCaseConditions, ReflexiveComparison, YodaConditions, [UseConditionDirectly](test/scala/LinterPluginTest.scala#L529), [UseIfExpression](test/scala/LinterPluginTest.scala#L102), [UnnecessaryElseBranch](test/scala/LinterPluginTest.scala#L112), [DuplicateIfBranches](test/scala/LinterPluginTest.scala#L554), IdenticalIfElseCondition, MergeNestedIfs, VariableAssignedUnusedValue, MalformedSwap, IdenticalIfCondition, IdenticalStatements, IndexingWithNegativeNumber, OptionOfOption, UndesirableTypeInference, AssigningOptionToNull, WrapNullWithOption, UseGetOrElseOnOption, UseOptionOrNull, UseOptionGetOrElse, UseExistsOnOption, UseFilterNotFlatMap, AvoidOptionStringSize, AvoidOptionCollectionSize, AvoidOptionMethod, [TransformNotMap](test/scala/LinterPluginTest.scala#L454), DuplicateKeyInMap, InefficientUseOfListSize, OnceEvaluatedStatementsInBlockReturningFunction, IntDivisionAssignedToFloat, UseFlattenNotFilterOption, PassPartialFunctionDirectly, [UnitImplicitOrdering](test/scala/LinterPluginTest.scala#L243), [RegexWarning](test/scala/LinterPluginTest.scala#L372), [InvariantCondition](test/scala/LinterPluginTest.scala#L408), DecomposingEmptyCollection, InvariantExtrema, UnnecessaryMethodCall, ProducesEmptyCollection, OperationAlwaysProducesZero, ModuloByOne, DivideByOne, DivideByZero, ZeroDivideBy, UseUntilNotToMinusOne, InvalidParamToRandomNextInt, UnusedForLoopIteratorValue, StringMultiplicationByNonPositive, LikelyIndexOutOfBounds, UnnecessaryReturn, InvariantReturn, [UnusedParameter](test/scala/LinterPluginTest.scala#L644), [InvalidStringFormat](test/scala/LinterPluginTest.scala#L302), InvalidStringConversion, UnnecessaryStringNonEmpty, UnnecessaryStringIsEmpty, [PossibleLossOfPrecision](test/scala/LinterPluginTest.scala#L228), [UnsafeAbs](test/scala/LinterPluginTest.scala#L255), [TypeToType](test/scala/LinterPluginTest.scala#L271), [EmptyStringInterpolator](test/scala/LinterPluginTest.scala#L319), [UnlikelyToString](test/scala/LinterPluginTest.scala#L328), [UnthrownException](test/scala/LinterPluginTest.scala#L338), [SuspiciousMatches](test/scala/LinterPluginTest.scala#L347), [UseFindNotFilterHead](test/scala/LinterPluginTest.scala#L363), [IfDoWhile](test/scala/LinterPluginTest.scala#L426)
